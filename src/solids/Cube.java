...
public class Cube extends SolidData {
        public Cube(double size){
            ...
            indicies.add(1); indicies.add(2); // 2. úsečka
            indicies.add(2); indicies.add(3); // 3. úsečka
            indicies.add(3); indicies.add(0); // 4. úsečka

            indicies.add(0); indicies.add(4); // 5. úsečka
            indicies.add(1); indicies.add(5); // 6. úsečka
            indicies.add(2); indicies.add(6); // 7. úsečka
            indicies.add(3); indicies.add(7); // 8. úsečka

            indicies.add(4); indicies.add(5); // 9. úsečka
            indicies.add(5); indicies.add(6); // 10. úsečka
            indicies.add(6); indicies.add(7); // 11. úsečka
            indicies.add(7); indicies.add(0); // 12. úsečka
